...
class GlucoseFilterForm(forms.Form):
    ...
    start_date = forms.DateField(label='Date Range', required=False, input_formats=[DATE_FORMAT])
    end_date = forms.DateField(label='', required=False, input_formats=[DATE_FORMAT])
